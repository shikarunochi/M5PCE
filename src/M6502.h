...
typedef struct
{
  ...
  word_s Trap;          /* Set Trap to address to trace from   */
...
/** in R.                                                   **/
/*************************************************************/
word_s Exec6502(register M6502 *R);
...
/*************************************************************/
word_s Run6502(register M6502 *R);
...
void _Wr6502(register word_s Addr,register byte Value);
byte _Rd6502(register word_s Addr);
//byte Op6502(register word_s Addr);
